...
For each panel in a given list (Excel file):
 - Retrieve the status of all gens within that panel
 - Export this information as an Excel list

Input is an Excel file containing panel name, panel id and version number.
"""
...
from pandas import *
xls = ExcelFile('panel_versions_list_20170605.xlsx')
